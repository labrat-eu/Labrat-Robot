...
template <>
void Mavlink::Node::MavlinkMessage<mavlink::common::LocalPositionNedSystemGlobalOffset>::convertFrom(const Converted &source,
  Storage &destination) {
...
template <>
void Mavlink::Node::MavlinkMessage<mavlink::common::SetPositionTargetLocalNed>::convertTo(const Storage &source, Converted &destination,
  const Mavlink::SystemInfo *info) {
...
template <>
void Mavlink::Node::MavlinkMessage<mavlink::common::CommandInt>::convertTo(const Storage &source, Converted &destination,
  const Mavlink::SystemInfo *info) {
...
template <>
void Mavlink::Node::MavlinkMessage<mavlink::common::CommandLong>::convertTo(const Storage &source, Converted &destination,
  const Mavlink::SystemInfo *info) {
