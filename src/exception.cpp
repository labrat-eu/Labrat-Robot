...
Exception::Exception(const std::string &message) : Exception(message, Logger("generic")) {}

Exception::Exception(const std::string &message, Logger &logger) : message(message) {
  logger.logDebug() << "Exception thrown: " << message;
}

Exception::Exception(const std::string &message, Logger &&logger) : Exception(message, std::forward<Logger &>(logger)) {}
...
Exception::Exception(const std::string &message, int code) : Exception(message, std::generic_category().default_error_condition(code)) {}
...
Exception::Exception(const std::string &message, int code, Logger &&logger) : Exception(message, code, std::forward<Logger &>(logger)) {}
